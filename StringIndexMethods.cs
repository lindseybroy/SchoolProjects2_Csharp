...
namespace Roy_CS317_U1_Guided_3
{
    class StringIndexMethods
    {
        public static void Main(string[] args)
        {
            string letters = "abcdefghijklmabcdefghijklm"; char[] searchLetters = { 'c', 'a', '$' };

            Console.WriteLine("First 'c' is located at index" + letters.IndexOf('c'));
            Console.WriteLine("First 'a' starting at 1 is located at index" + letters.IndexOf('c'));
            Console.WriteLine("First '$' in the 5 positions starting at 3" + "is located at index" +
                letters.IndexOf('$', 3, 5));
            ...
            Console.WriteLine("\nFirst \"def\" is loated at index" +
                letters.IndexOf("def"));
            Console.WriteLine("First\"def\" starting at 7 is located at" +
                "index" + letters.IndexOf("def", 7));
            Console.WriteLine("First \"hello\" in the 15 positions" + "starting at 5 is loated at index" +
            ...
            Console.WriteLine("First 'c', 'a', or '$' startng at 7 is" +
